...
// note: waffle comes from hardhat and not direct
...
const showcaseAbi = ShowcaseArtifacts.abi;
...
describe("Showcase", () => {
  ...
  const showcaseFixture = async () => {
    ...
    const showcase = await deployContract(w0, ShowcaseArtifacts, [usdcAddress]);
